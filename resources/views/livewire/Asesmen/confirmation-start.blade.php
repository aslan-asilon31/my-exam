    ...
    <div class=" ">
        <div class="max-w-4xl mx-auto bg-white p-8 rounded-md shadow-lg ">
            ...
            <div class="flex justify-center mt-2 gap-4">
                ...
                <a href="/asesmen/{{ $asesmen['id'] }}" class="text-xs md:text-sm bg-orange-900 hover:bg-orange-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-4">
                    Mulai Ujian
                </a>
            </div>
        </div>
